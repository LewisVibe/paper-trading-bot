...
REQUIRED_TOKENS = [
    ...
    "split_validation_strong",
    "split_validation_mixed",
    "split_validation_weak",
    "split_validation_needs_more_data",
    "split_validation_benchmark_lagging",
    "drawdown_acceptable_for_return",
    "drawdown_watch",
    "drawdown_worse_than_reference",
    "recovery_watch",
    "benchmark_lagging_but_active_leader",
    "benchmark_gap_too_large",
    "benchmark_tradeoff_acceptable",
    "beats_active_reference",
    "equal_weight_comparison_pass",
    "equal_weight_comparison_fail",
    "SPY_BENCHMARK",
