...
INPUT_FILES = {
    ...
    "vol_ticket_values_approval_record": Path("data/vol_targeted_growth_ticket_values_approval_record_summary.csv"),
    ...
    "vol_executable_ticket_draft_readiness": Path("data/vol_targeted_growth_executable_ticket_draft_readiness_summary.csv"),
    ...
    "vol_review_only_draft_ticket_values": Path("data/vol_targeted_growth_review_only_draft_ticket_values_summary.csv"),
    "vol_review_only_draft_ticket_values_quality_gate": Path("data/vol_targeted_growth_review_only_draft_ticket_values_quality_gate_summary.csv"),
    "vol_draft_ticket_values_manual_review": Path("data/vol_targeted_growth_draft_ticket_values_manual_review_summary.csv"),
    ...
    "vol_non_submitting_ticket_creation_readiness": Path("data/vol_targeted_growth_non_submitting_ticket_creation_readiness_summary.csv"),
    "vol_non_submitting_ticket_instance_checkpoint": Path("data/vol_targeted_growth_non_submitting_ticket_instance_checkpoint_summary.csv"),
    "vol_non_submitting_ticket_instance_quality_gate": Path("data/vol_targeted_growth_non_submitting_ticket_instance_quality_gate_summary.csv"),
...
def show_paper_live_go_no_go_dashboard(root_dir: Path | str = ".") -> tuple[int, list[str]]:
    ...
    return 0, [
        ...
        f"vol_ticket_value_discussion_approved: {summary_value(rows, 'vol_ticket_value_discussion_approved')}",
        ...
        f"vol_executable_ticket_draft_readiness_decision: {summary_value(rows, 'vol_executable_ticket_draft_readiness_decision')}",
        f"vol_executable_ticket_draft_discussion_ready: {summary_value(rows, 'vol_executable_ticket_draft_discussion_ready')}",
        f"vol_non_submitting_executable_ticket_draft_decision: {summary_value(rows, 'vol_non_submitting_executable_ticket_draft_decision')}",
        ...
        f"vol_review_only_draft_ticket_values_decision: {summary_value(rows, 'vol_review_only_draft_ticket_values_decision')}",
        f"vol_review_only_draft_ticket_values_quality_gate_decision: {summary_value(rows, 'vol_review_only_draft_ticket_values_quality_gate_decision')}",
        f"vol_review_only_draft_ticket_values_quality_gate_passed: {summary_value(rows, 'vol_review_only_draft_ticket_values_quality_gate_passed')}",
        f"vol_draft_ticket_values_manual_review_decision: {summary_value(rows, 'vol_draft_ticket_values_manual_review_decision')}",
        f"vol_executable_ticket_values_readiness_decision: {summary_value(rows, 'vol_executable_ticket_values_readiness_decision')}",
        f"vol_executable_ticket_values_approval_request_ready: {summary_value(rows, 'vol_executable_ticket_values_approval_request_ready')}",
        f"vol_executable_ticket_values_approval_wording_decision: {summary_value(rows, 'vol_executable_ticket_values_approval_wording_decision')}",
        ...
        f"vol_non_submitting_executable_ticket_values_order_values_populated: {summary_value(rows, 'vol_non_submitting_executable_ticket_values_order_values_populated')}",
        f"vol_non_submitting_executable_ticket_values_manual_review_decision: {summary_value(rows, 'vol_non_submitting_executable_ticket_values_manual_review_decision')}",
...
def build_summary_rows(inputs: dict[str, list[dict[str, str]]], report_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    ticket_values_record_status = summary_value(inputs["vol_ticket_values_approval_record"], "final_ticket_values_record_status") or "missing_vol_ticket_values_approval_record"
    ticket_values_record_decision = summary_value(inputs["vol_ticket_values_approval_record"], "final_ticket_values_record_decision") or "missing_vol_ticket_values_approval_record_decision"
    ticket_value_discussion_approved = summary_value(inputs["vol_ticket_values_approval_record"], "ticket_value_discussion_approved") or "False"
    ticket_values_approved = summary_value(inputs["vol_ticket_values_approval_record"], "ticket_values_approved") or "False"
    ticket_value_placeholder_decision = summary_value(inputs["vol_ticket_value_placeholders"], "final_ticket_value_placeholder_decision") or "missing_vol_ticket_value_placeholders"
    ticket_value_placeholder_populated_count = summary_value(inputs["vol_ticket_value_placeholders"], "populated_order_value_count") or "0"
    ticket_value_quality_gate_decision = summary_value(inputs["vol_ticket_value_quality_gate"], "final_ticket_value_quality_gate_decision") or "missing_vol_ticket_value_quality_gate"
    ticket_value_quality_gate_passed = summary_value(inputs["vol_ticket_value_quality_gate"], "quality_gate_passed") or "False"
    ...
    executable_ticket_draft_readiness_decision = summary_value(inputs["vol_executable_ticket_draft_readiness"], "final_executable_ticket_draft_readiness_decision") or "missing_vol_executable_ticket_draft_readiness"
    executable_ticket_draft_discussion_ready = summary_value(inputs["vol_executable_ticket_draft_readiness"], "draft_discussion_ready") or "False"
    non_submitting_ticket_draft_decision = summary_value(inputs["vol_non_submitting_executable_ticket_draft"], "final_ticket_draft_decision") or "missing_vol_non_submitting_executable_ticket_draft"
    non_submitting_ticket_draft_created = summary_value(inputs["vol_non_submitting_executable_ticket_draft"], "draft_ticket_created") or "False"
    non_submitting_ticket_draft_quality_decision = summary_value(inputs["vol_non_submitting_executable_ticket_draft_quality_gate"], "final_ticket_draft_quality_decision") or "missing_vol_non_submitting_executable_ticket_draft_quality_gate"
    non_submitting_ticket_draft_quality_passed = summary_value(inputs["vol_non_submitting_executable_ticket_draft_quality_gate"], "quality_gate_passed") or "False"
    draft_ticket_value_approval_readiness_decision = summary_value(inputs["vol_draft_ticket_value_approval_readiness"], "final_ticket_value_approval_readiness_decision") or "missing_vol_draft_ticket_value_approval_readiness"
    ...
    review_only_draft_ticket_values_decision = summary_value(inputs["vol_review_only_draft_ticket_values"], "final_review_only_draft_ticket_values_decision") or "missing_vol_review_only_draft_ticket_values"
    review_only_draft_ticket_values_created = summary_value(inputs["vol_review_only_draft_ticket_values"], "draft_ticket_values_created") or "False"
    review_only_draft_ticket_values_quality_decision = summary_value(inputs["vol_review_only_draft_ticket_values_quality_gate"], "final_review_only_draft_ticket_values_quality_decision") or "missing_vol_review_only_draft_ticket_values_quality_gate"
    review_only_draft_ticket_values_quality_passed = summary_value(inputs["vol_review_only_draft_ticket_values_quality_gate"], "quality_gate_passed") or "False"
    draft_ticket_values_manual_review_decision = summary_value(inputs["vol_draft_ticket_values_manual_review"], "final_draft_ticket_values_manual_review_decision") or "missing_vol_draft_ticket_values_manual_review"
    draft_ticket_values_manual_review_completed = summary_value(inputs["vol_draft_ticket_values_manual_review"], "manual_review_completed") or "False"
    executable_ticket_values_readiness_decision = summary_value(inputs["vol_executable_ticket_values_readiness"], "final_executable_ticket_values_readiness_decision") or "missing_vol_executable_ticket_values_readiness"
    executable_ticket_values_approval_request_ready = summary_value(inputs["vol_executable_ticket_values_readiness"], "executable_ticket_values_approval_request_ready") or "False"
    executable_ticket_values_approval_wording_decision = summary_value(inputs["vol_executable_ticket_values_approval_wording"], "final_executable_ticket_values_approval_wording_decision") or "missing_vol_executable_ticket_values_approval_wording"
    executable_ticket_values_approval_record_decision = summary_value(inputs["vol_executable_ticket_values_approval_record"], "final_executable_ticket_values_approval_record_decision") or "missing_vol_executable_ticket_values_approval_record"
    ...
    non_submitting_values_quality_decision = summary_value(inputs["vol_non_submitting_executable_ticket_values_quality_gate"], "final_non_submitting_executable_ticket_values_quality_decision") or "missing_vol_non_submitting_executable_ticket_values_quality_gate"
    non_submitting_values_quality_passed = summary_value(inputs["vol_non_submitting_executable_ticket_values_quality_gate"], "quality_gate_passed") or "False"
    non_submitting_values_manual_review_decision = summary_value(inputs["vol_non_submitting_executable_ticket_values_manual_review"], "final_non_submitting_executable_ticket_values_manual_review_decision") or "missing_vol_non_submitting_executable_ticket_values_manual_review"
    non_submitting_values_manual_review_completed = summary_value(inputs["vol_non_submitting_executable_ticket_values_manual_review"], "manual_review_completed") or "False"
    ticket_creation_readiness_decision = summary_value(inputs["vol_non_submitting_ticket_creation_readiness"], "final_non_submitting_ticket_creation_readiness_decision") or "missing_vol_non_submitting_ticket_creation_readiness"
    ticket_creation_discussion_ready = summary_value(inputs["vol_non_submitting_ticket_creation_readiness"], "ticket_creation_discussion_ready") or "False"
    ...
    ticket_instance_quality_decision = summary_value(inputs["vol_non_submitting_ticket_instance_quality_gate"], "final_non_submitting_ticket_instance_quality_decision") or "missing_vol_non_submitting_ticket_instance_quality_gate"
    ticket_instance_quality_passed = summary_value(inputs["vol_non_submitting_ticket_instance_quality_gate"], "pre_ticket_quality_gate_passed") or "False"
    ticket_instance_quality_review_inputs_complete = summary_value(inputs["vol_non_submitting_ticket_instance_quality_gate"], "review_inputs_complete") or "False"
    ticket_instance_quality_protected_blank = summary_value(inputs["vol_non_submitting_ticket_instance_quality_gate"], "protected_order_fields_blank") or "False"
    ticket_instance_quality_largest_blocker = summary_value(inputs["vol_non_submitting_ticket_instance_quality_gate"], "largest_blocker") or "missing_vol_non_submitting_ticket_instance_quality_gate"
    checklist_status = summary_value(inputs["paper_live_checklist"], "checklist_phase_status") or "missing_paper_live_checklist"
    ...
    data = [
        ...
        ("vol_ticket_values_approval_record_status", ticket_values_record_status, "Saved ticket-values discussion approval record status."),
        ("vol_ticket_values_approval_record_decision", ticket_values_record_decision, "Saved ticket-values discussion approval record decision."),
        ("vol_ticket_value_discussion_approved", ticket_value_discussion_approved, "True means discussion/placeholders may continue; values remain unapproved."),
        ("vol_ticket_values_approved", ticket_values_approved, "Must remain False."),
        ("vol_ticket_value_placeholder_decision", ticket_value_placeholder_decision, "Saved non-executable placeholder decision."),
        ("vol_ticket_value_placeholder_populated_count", ticket_value_placeholder_populated_count, "Must remain 0."),
        ("vol_ticket_value_quality_gate_decision", ticket_value_quality_gate_decision, "Saved placeholder quality-gate decision."),
        ("vol_ticket_value_quality_gate_passed", ticket_value_quality_gate_passed, "True only for non-executable placeholder checks."),
        ...
        ("vol_executable_ticket_draft_readiness_decision", executable_ticket_draft_readiness_decision, "Saved readiness decision for a future non-submitting draft discussion."),
        ("vol_executable_ticket_draft_discussion_ready", executable_ticket_draft_discussion_ready, "True only for a future manual discussion; not a ticket or approval."),
        ("vol_non_submitting_executable_ticket_draft_decision", non_submitting_ticket_draft_decision, "Saved non-submitting draft ticket decision."),
        ("vol_non_submitting_executable_ticket_draft_created", non_submitting_ticket_draft_created, "True means a review draft exists; it is not executable."),
        ("vol_non_submitting_executable_ticket_draft_quality_gate_decision", non_submitting_ticket_draft_quality_decision, "Saved draft quality-gate decision."),
        ("vol_non_submitting_executable_ticket_draft_quality_gate_passed", non_submitting_ticket_draft_quality_passed, "True only when draft remains non-executable."),
        ("vol_draft_ticket_value_approval_readiness_decision", draft_ticket_value_approval_readiness_decision, "Saved readiness decision before any future ticket-value approval request."),
        ...
        ("vol_review_only_draft_ticket_values_decision", review_only_draft_ticket_values_decision, "Saved review-only draft values decision."),
        ("vol_review_only_draft_ticket_values_created", review_only_draft_ticket_values_created, "True means review labels exist; not executable values."),
        ("vol_review_only_draft_ticket_values_quality_gate_decision", review_only_draft_ticket_values_quality_decision, "Saved quality gate decision for review-only draft values."),
        ("vol_review_only_draft_ticket_values_quality_gate_passed", review_only_draft_ticket_values_quality_passed, "True only when values remain non-executable."),
        ("vol_draft_ticket_values_manual_review_decision", draft_ticket_values_manual_review_decision, "Saved manual review decision for draft ticket values."),
        ("vol_draft_ticket_values_manual_review_completed", draft_ticket_values_manual_review_completed, "True means saved-output manual review checkpoint exists."),
        ("vol_executable_ticket_values_readiness_decision", executable_ticket_values_readiness_decision, "Saved readiness decision for future executable-values approval request."),
        ("vol_executable_ticket_values_approval_request_ready", executable_ticket_values_approval_request_ready, "True means a future request may be considered; not requested now."),
        ("vol_executable_ticket_values_approval_wording_decision", executable_ticket_values_approval_wording_decision, "Saved executable ticket-values approval wording decision."),
        ("vol_executable_ticket_values_approval_record_decision", executable_ticket_values_approval_record_decision, "Saved executable ticket-values approval record decision."),
        ...
        ("vol_non_submitting_executable_ticket_values_populated", non_submitting_values_populated, "True when reviewable non-submitting values exist."),
        ("vol_non_submitting_executable_ticket_values_order_values_populated", non_submitting_values_order_values_populated, "Must remain False because no broker-ready order values exist."),
        ("vol_non_submitting_executable_ticket_values_manual_review_decision", non_submitting_values_manual_review_decision, "Saved manual-review decision for non-submitting values."),
        ("vol_non_submitting_executable_ticket_values_manual_review_completed", non_submitting_values_manual_review_completed, "True when saved-output manual review is complete."),
        ("vol_non_submitting_ticket_creation_readiness_decision", ticket_creation_readiness_decision, "Saved readiness decision for future ticket-instance discussion."),
        ("vol_non_submitting_ticket_creation_discussion_ready", ticket_creation_discussion_ready, "True means future ticket-instance discussion can be considered."),
        ...
        ("vol_non_submitting_ticket_instance_quality_decision", ticket_instance_quality_decision, "Saved pre-ticket quality-gate decision."),
        ("vol_non_submitting_ticket_instance_quality_gate_passed", ticket_instance_quality_passed, "True only means the checkpoint is complete and clean for manual review."),
        ("vol_non_submitting_ticket_instance_quality_review_inputs_complete", ticket_instance_quality_review_inputs_complete, "Saved review inputs must be complete before broker-ready design discussion."),
        ("vol_non_submitting_ticket_instance_quality_protected_order_fields_blank", ticket_instance_quality_protected_blank, "Protected order fields must remain blank."),
        ("vol_non_submitting_ticket_instance_quality_largest_blocker", ticket_instance_quality_largest_blocker, "Passing still keeps broker-ready ticket values blocked."),
...
def build_blocker_rows(inputs: dict[str, list[dict[str, str]]]) -> list[dict[str, Any]]:
    rows = [
        ...
        ("review_only_draft_ticket_values_are_not_executable", "blocked", "critical", "Review-only draft ticket values may exist and pass quality checks while ticket_values_approved and order_values_populated remain false.", "manual_review_draft_ticket_values_before_any_executable_ticket_values"),
        ("executable_ticket_values_readiness_is_not_approval", "blocked", "critical", "Executable ticket-values readiness can support a future request only; it does not request approval, record approval, or populate broker-ready values.", "manual_review_before_any_explicit_executable_ticket_values_approval_request"),
        ("executable_ticket_values_approval_is_not_value_population", "blocked", "critical", "Executable ticket-values approval may allow a later non-submitting value population step, but order_values_populated and executable_ticket_created remain false.", "populate_non_submitting_executable_ticket_values_for_manual_review_only"),
        ("non_submitting_executable_ticket_values_are_not_orders", "blocked", "critical", "Non-submitting values may be populated for manual review while broker-ready order values, tickets, and execution remain false.", "manual_review_non_submitting_executable_ticket_values_before_any_ticket_creation"),
        ("ticket_creation_readiness_is_not_ticket_creation", "blocked", "critical", "Ticket-creation readiness can support future discussion only; ticket_creation_approved, ticket_instance_created, and executable_ticket_created remain false.", "manual_review_ticket_creation_readiness_before_any_ticket_instance_checkpoint"),
        ("ticket_instance_checkpoint_is_not_executable", "blocked", "critical", "The non-submitting ticket-instance checkpoint can exist while ticket_instance_created, executable_ticket_created, and orders_submitted remain false.", "manual_review_checkpoint_before_any_broker_ready_ticket_values"),
...
def build_summary_lines(summary_rows: list[dict[str, Any]], output_paths: dict[str, Path]) -> list[str]:
    return [
        ...
        f"vol_ticket_values_approval_record_decision={summary_value(summary_rows, 'vol_ticket_values_approval_record_decision')}",
        f"vol_ticket_value_discussion_approved={summary_value(summary_rows, 'vol_ticket_value_discussion_approved')}",
        f"vol_ticket_values_approved={summary_value(summary_rows, 'vol_ticket_values_approved')}",
        ...
        f"vol_executable_ticket_draft_readiness_decision={summary_value(summary_rows, 'vol_executable_ticket_draft_readiness_decision')}",
        ...
        f"vol_review_only_draft_ticket_values_decision={summary_value(summary_rows, 'vol_review_only_draft_ticket_values_decision')}",
        f"vol_review_only_draft_ticket_values_quality_gate_decision={summary_value(summary_rows, 'vol_review_only_draft_ticket_values_quality_gate_decision')}",
        f"vol_draft_ticket_values_manual_review_decision={summary_value(summary_rows, 'vol_draft_ticket_values_manual_review_decision')}",
        f"vol_executable_ticket_values_readiness_decision={summary_value(summary_rows, 'vol_executable_ticket_values_readiness_decision')}",
        f"vol_executable_ticket_values_approval_request_ready={summary_value(summary_rows, 'vol_executable_ticket_values_approval_request_ready')}",
        f"vol_executable_ticket_values_approval_wording_decision={summary_value(summary_rows, 'vol_executable_ticket_values_approval_wording_decision')}",
        ...
        f"vol_non_submitting_executable_ticket_values_order_values_populated={summary_value(summary_rows, 'vol_non_submitting_executable_ticket_values_order_values_populated')}",
        f"vol_non_submitting_executable_ticket_values_manual_review_decision={summary_value(summary_rows, 'vol_non_submitting_executable_ticket_values_manual_review_decision')}",
        f"vol_non_submitting_ticket_creation_readiness_decision={summary_value(summary_rows, 'vol_non_submitting_ticket_creation_readiness_decision')}",
        f"vol_non_submitting_ticket_creation_discussion_ready={summary_value(summary_rows, 'vol_non_submitting_ticket_creation_discussion_ready')}",
        ...
        f"vol_non_submitting_ticket_instance_quality_decision={summary_value(summary_rows, 'vol_non_submitting_ticket_instance_quality_decision')}",
        f"vol_non_submitting_ticket_instance_quality_gate_passed={summary_value(summary_rows, 'vol_non_submitting_ticket_instance_quality_gate_passed')}",
        f"vol_non_submitting_ticket_instance_quality_largest_blocker={summary_value(summary_rows, 'vol_non_submitting_ticket_instance_quality_largest_blocker')}",
