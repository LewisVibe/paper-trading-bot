...
def build_gate_rows(created_at: str) -> list[dict[str, Any]]:
    return [
        ...
        gate_row(created_at, "unmapped_sleeve_boundary", "required", "critical", "Any sleeve not mapped to a single approved broker symbol must stay manual-review only and cannot become an order instruction.", "The saved broker comparison can confirm QQQ, but high-growth, crypto, and defensive sleeves are not single-symbol paper actions.", "block_candidate_discussion", "design_symbol_mapping_policy_before_any_candidate_discussion"),
...
def build_summary_rows(
    ...
    rows = [
        ...
        ("unmapped_sleeve_status", "unmapped_sleeves_block_order_instructions", "Non-QQQ sleeves are not mapped to executable paper symbols by this gate design."),
...
def build_blocker_rows(final_status: str) -> list[dict[str, Any]]:
    rows = [
        ...
        ("unmapped_sleeves_not_actionable", "blocked", "critical", "Unmapped sleeves cannot become executable action rows or order instructions.", "design_symbol_mapping_policy_before_any_candidate_discussion"),
