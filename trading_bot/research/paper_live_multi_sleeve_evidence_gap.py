...
def build_evidence_specs() -> list[EvidenceSpec]:
    return [
        ...
        EvidenceSpec(
            ...
            "allocator_saved_policy_or_lead_state_evidence_present_future_only_no_portfolio_execution_wiring",
            "allocator_saved_policy_or_lead_state_evidence_incomplete_future_only_no_portfolio_execution_wiring",
