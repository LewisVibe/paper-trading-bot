...
Volatility-targeted growth seed-change evidence pack uses `python bot.py --vol-targeted-growth-seed-change-evidence-pack` and `python bot.py --show-vol-targeted-growth-seed-change-evidence-pack`. It lists required evidence before QQQ100 displacement could even be proposed and should remain incomplete until component, risk, stress, cost, split, exposure, action-preview, and formal proposal evidence exists. It must not change the seed, approve displacement, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth seed-change risk/reward comparison uses `python bot.py --vol-targeted-growth-seed-change-risk-reward-comparison` and `python bot.py --show-vol-targeted-growth-seed-change-risk-reward-comparison`. It compares saved QQQ100 and volatility candidate metrics only and marks source mismatch/manual review as a blocker. It must not refresh market data, change the seed, approve displacement, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth seed-change drawdown/stress review uses `python bot.py --vol-targeted-growth-seed-change-drawdown-stress-review` and `python bot.py --show-vol-targeted-growth-seed-change-drawdown-stress-review`. It compares saved QQQ100 and volatility candidate MaxDD evidence only and marks stress-window/source review as incomplete. It must not refresh market data, change the seed, approve displacement, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth seed-change cost/turnover review uses `python bot.py --vol-targeted-growth-seed-change-cost-turnover-review` and `python bot.py --show-vol-targeted-growth-seed-change-cost-turnover-review`. It reads saved outputs only and records that exact cost/turnover stress is still missing for a seed-change proposal. It must not refresh market data, change the seed, approve displacement, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth seed-change split-stability review uses `python bot.py --vol-targeted-growth-seed-change-split-stability-review` and `python bot.py --show-vol-targeted-growth-seed-change-split-stability-review`. It reads saved split evidence only and preserves the supportive-but-manual-review label. It must not refresh market data, change the seed, approve displacement, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth remaining seed-change evidence reviews use `python bot.py --vol-targeted-growth-seed-change-component-sleeve-review`, `python bot.py --vol-targeted-growth-seed-change-action-preview-design`, and `python bot.py --vol-targeted-growth-seed-change-proposal-document`, plus matching display commands. They are saved-output checkpoints only. The proposal document is draft-only; it must not create a formal seed-change proposal, displace QQQ100, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth seed-change broker-exposure review uses `python bot.py --vol-targeted-growth-seed-change-broker-exposure-review` and `python bot.py --show-vol-targeted-growth-seed-change-broker-exposure-review`. It reviews saved broker-comparison output only and must not call Alpaca, read positions again, create a formal seed-change proposal, displace QQQ100, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth seed-change manual-review checkpoint uses `python bot.py --vol-targeted-growth-seed-change-manual-review-checkpoint` and `python bot.py --show-vol-targeted-growth-seed-change-manual-review-checkpoint`. It may mark completed evidence as ready for human formal-proposal review, but it must not create the formal proposal, change the seed, displace QQQ100, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth formal seed-change proposal uses `python bot.py --vol-targeted-growth-formal-seed-change-proposal` and `python bot.py --show-vol-targeted-growth-formal-seed-change-proposal`. It creates a saved proposal document for human review only. It must not record manual approval, change the seed, add action-preview implementation, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth seed-change manual approval record uses `python bot.py --vol-targeted-growth-seed-change-manual-approval-record` and `python bot.py --show-vol-targeted-growth-seed-change-manual-approval-record`. It records approval to design the seed-change implementation only. It must not change the seed, displace QQQ100, add action-preview implementation, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.

Volatility-targeted growth seed-change implementation design uses `python bot.py --vol-targeted-growth-seed-change-implementation-design` and `python bot.py --show-vol-targeted-growth-seed-change-implementation-design`. It describes the future code-change boundaries only. It must not change the seed, displace QQQ100, add action-preview implementation, call Alpaca, read positions, create order fields, wire execution, or approve execution/scheduling.
