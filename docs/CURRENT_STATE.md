...
- The stricter-gate validation and promotion-readiness checkpoints are research-only. They can support future preview-candidate discussion only after separate manual review, but they do not approve execution, paper execution, preview promotion, promoted execution, scheduling, or cron.
